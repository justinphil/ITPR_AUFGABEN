...
*  Da Groß A in der ASCII Zeichenkette 65 steht, wird die Position im Alphabet berechnet
*/ 
...
{   
    {
        ...
        // iFeldSize ist eine Konstante Zahl, die die Gr��e des Feldes iFeld bestimmt.
